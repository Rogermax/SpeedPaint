...
public class PointsThread extends Thread {
	...
	private static final String TAG = PointsThread.class.getSimpleName();
	private SurfaceHolder surfaceHolder;
	private PointsView gamePanel;
	...
	private double averageFps = MAX_FPS;

	public PointsThread(SurfaceHolder sh, PointsView view, int w, int h) {
		super();
